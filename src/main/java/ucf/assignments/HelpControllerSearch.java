...
public class HelpControllerSearch {
    ...
    public String nextButtonPressed() {
        ...
        try {
            ...
            // Open previous scene
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("HelpControllerSortItems.fxml")));
            ...
            System.out.print("Scene switched to HelpControllerSortItems.fxml\n");
            return "Scene switched to HelpControllerSortItems.fxml\n";
        } catch(Exception e) {
    ...
    public void initialize() {
        assert returnButton != null : "fx:id=\"returnButton\" was not injected: check your FXML file 'HelpControllerSearch.fxml'.";
        assert nextButton != null : "fx:id=\"nextButton\" was not injected: check your FXML file 'HelpControllerSearch.fxml'.";
        assert backButton != null : "fx:id=\"backButton\" was not injected: check your FXML file 'HelpControllerSearch.fxml'.";
